...
import { createTown } from '@/app/actions/towns';

async function createTownWithRedirect(formData: FormData) {
  'use server';
  const result = await createTown(formData);
  if (result.success) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <form action={createTownWithRedirect} className="space-y-6">
